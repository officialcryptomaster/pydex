...
def test_account_address(web3_client):  # pylint: disable=redefined-outer-name
    ...
    """
    web3_client.private_key = "f2f48ee19680706196e2e339e5da3491186e0c4c5030670656b0e0164837257d"
    expected_public_key = "0x5409ed021d9299bf6814279a6a1411a7e866a631"
    assert web3_client.account_address == expected_public_key


def test_sign_hash(web3_client):  # pylint: disable=redefined-outer-name
    ...
    signature_0x = web3_client.sign_hash_0x_compat(hash_hex)
